$(function () {
    ...
    $(".swiper-container ul li").click(function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                var face_number = data.data.faces.length;
                ...
                $(".bboxvalue").text("");
                $(".kpointvalue").text("");
                data.data.faces.forEach(function (value, index, array) {
    ...
    function uploadImage(img){
        ...
        var imgsource = $(".face-top").children("img")[0];
         $.ajax({
            url: '/',
            method: "POST",
            cache: false,
            ...
            success: function (data) {
                ...
                data.data.faces.forEach(function (value, index, array) {
                    ...
                    var canvas2 = document.getElementById("canvas" + index);
                    var context2 = canvas2.getContext('2d');
                    context2.drawImage(imgsource, bbox.x1, bbox.y1, bbox.x2 - bbox.x1, bbox.y2 - bbox.y1, 0, 0, 100, 100)
                })
